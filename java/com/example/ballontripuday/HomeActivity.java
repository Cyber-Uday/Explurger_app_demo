...
public class HomeActivity extends AppCompatActivity {
   ...
   @SuppressLint("MissingInflatedId")
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       {
           TabLayout tabLayout = findViewById(R.id.tabLayout5);
           tabLayout.setBackgroundColor(getResources().getColor(R.color.tab_background_color));
       }
       ...
       setContentView(R.layout.activity_home2);
        ...
        viewPagerAdapter.addFragment(new ChatsFragment(),"APP DOMAIN");
        viewPagerAdapter.addFragment(new StatusFragment(),"Privacy");
        viewPagerAdapter.addFragment(new CallsFragment(),"Host");
    ...
    private void welcome() {
        ...
        ad.setTitle(" Uday Explurzer App");
        ad.setMessage("Hello,Welcome To You In Trip App");
